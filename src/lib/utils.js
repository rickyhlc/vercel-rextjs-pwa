...
export const getRouteURL = (company, route, bound, serviceType) => {
  return `/bus/route/${company}/${route}/${bound}/${serviceType}/workaround`;
}
...
export const BORDER_BTN_BLUE = `active:border-blue-200 dark:active:border-blue-400 hover:border-blue-200/85 dark:hover:border-blue-400/85 border-1 rounded-full disabled:bg-transparent dark:disabled:bg-transparent active:bg-blue-200 dark:active:bg-blue-400 hover:bg-blue-200/85 dark:hover:bg-blue-400/85 disabled:border-zinc-400 dark:disabled:border-zinc-600 ${TXT_ZINC} ${TXT_DISABLED}`;