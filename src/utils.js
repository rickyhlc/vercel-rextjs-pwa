...
export const BTN_BLUER = `${BG_DISABLED} bg-blue-200/70 dark:bg-blue-800/70 active:bg-blue-200 dark:active:bg-blue-800 hover:bg-blue-200/85 dark:hover:bg-blue-800/85 ${TXT_ZINC}`;
